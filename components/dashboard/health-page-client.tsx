          ...
          <li className={cn("p-4", uiStyles.insetSurface)} key={customer.id}>
            <article aria-labelledby={`${customer.id}-health-title`}>
              <div className="flex flex-wrap items-center justify-between gap-2">
                <h3 className="text-sm font-semibold text-slate-950 dark:text-white" id={`${customer.id}-health-title`}>
                  {customer.company}
                </h3>
              ...
              <div className="mt-4 space-y-2">
                <div className="flex items-center justify-between gap-3 text-sm">
                  ...
                  <span className="font-medium text-slate-950 dark:text-white">{customer.healthScore}/100</span>
                </div>
                <MeterBar
