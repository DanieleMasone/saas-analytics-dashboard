              ...
              <section aria-label="Revenue watch items" className="grid gap-3 md:grid-cols-2">
                <article className={cn("p-4", uiStyles.surface)}>
                  ...
                  <p className={cn("mt-2", uiStyles.bodyText)}>
                    Expansion is tracking above churn, with the latest month
                    adding {formatCurrency(data.at(-1)?.expansion ?? 0, true)}.
                  </p>
                </article>
                <article className={cn("p-4", uiStyles.surface)}>
                  <div
                  ...
                  <p className={cn("mt-2", uiStyles.bodyText)}>
                    Current churn impact is {formatCurrency(Math.abs(data.at(-1)?.churn ?? 0), true)} and
                    should stay below new business velocity.
                  </p>
                </article>
                <article className={cn("p-4 md:col-span-2", uiStyles.surface)}>
                  ...
                  <p className={cn("mt-2", uiStyles.bodyText)}>
                    The customer base closed at {formatNumber(data.at(-1)?.customers ?? 0)} accounts in the
